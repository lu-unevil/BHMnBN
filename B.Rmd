...
- Epistemic BNs for probabilistic reasoning of the state of a system (effective, toxic, present, invasive etc) when the BN is informed by one or several sources of evidence
]
---
class: left, middle
